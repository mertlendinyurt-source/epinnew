        ...
        <div className="max-w-[1920px] mx-auto">
          <div className="flex items-center gap-2 px-4 md:px-6 py-3 overflow-x-auto scrollbar-hide">
            ...
            <div className="relative group flex-shrink-0">
              <button className="flex items-center gap-2 px-3 md:px-4 py-2.5 bg-white/5 hover:bg-white/10 rounded-lg transition-all border border-white/10">
            ...
            <a 
              href="/" 
              className="flex items-center gap-2 px-3 md:px-4 py-2.5 bg-gradient-to-r from-blue-600/20 to-purple-600/20 hover:from-blue-600/30 hover:to-purple-600/30 rounded-lg transition-all border border-blue-500/20 flex-shrink-0"
            >
              <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <span className="text-xs md:text-sm font-medium text-white whitespace-nowrap">Bütün Teklifler</span>
            </a>
