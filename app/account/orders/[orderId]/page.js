                  ...
                  {(order.productTitle?.toLowerCase().includes('valorant') || order.productTitle?.toLowerCase().includes('vp')) && (
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          <p className="text-white font-medium">{isEN ? 'Go to "Redeem Code" section' : '"Kod Kullan" veya "Redeem Code" bölümüne gidin'}</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">{isEN ? 'From Settings > "Exchange Code" option' : 'Ayarlar içinden "Exchange Code" veya "Kod Kullan" seçeneği'}</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
