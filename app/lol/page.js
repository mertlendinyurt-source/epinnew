            ...
            <div className="mb-8 p-6 bg-white/5 rounded-xl border border-white/10">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white/70 text-sm font-medium">PİNLY LTD. ŞTİ.</p>
                  <p className="text-white/50 text-xs">Vergi Dairesi: DİKİMEVİ</p>
                  <p className="text-white/50 text-xs">Vergi No: 9860350286</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white/50 text-xs leading-relaxed">
                    MUTLU MAH. 698 SK. HİLAL APT<br />
                    NO: 18 İÇ KAPI NO: 5<br />
                    MAMAK / ANKARA
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white/50 text-xs">
                    <span className="text-white/70">Tel:</span> 0850 346 96 71
                  </p>
                  <p className="text-white/50 text-xs">
                    <span className="text-white/70">Fax:</span> 0850 346 96 71
                  </p>
                  <p className="text-white/50 text-xs">
                    <span className="text-white/70">E-posta:</span> info@pinly.com.tr
                  </p>
                </div>
              </div>
            </div>
