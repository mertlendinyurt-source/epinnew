          ...
          <div className="flex-1">
            {loading ? (
              ...
              <div className="relative rounded-2xl overflow-hidden">
                {/* MLBB Theme Background */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#1a2a3e] via-[#1a3d5c] to-[#1a2a4e]"></div>
                {/* Logo Pattern */}
                <div className="absolute inset-0 opacity-[0.07]" style={{
                  backgroundImage: `url('/mlbb-logo.png')`,
                  backgroundSize: '120px 120px',
                  backgroundRepeat: 'repeat'
                }}></div>
                {/* Glow Effects */}
                <div className="absolute top-0 left-1/4 w-96 h-48 bg-blue-500/20 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 right-1/4 w-96 h-48 bg-cyan-500/15 rounded-full blur-3xl"></div>
