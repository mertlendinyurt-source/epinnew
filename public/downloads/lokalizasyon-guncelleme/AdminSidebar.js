...
const menuGroups = [
  {
    ...
    items: [
      ...
      { href: '/admin/daily-deals', icon: Star, label: '🔥 Günün Fırsatları', color: 'text-orange-400' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/settings/payyeen', icon: CreditCard, label: 'Payyeen Ayarları', color: 'text-cyan-400' },
