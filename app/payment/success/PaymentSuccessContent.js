...
// DÜZELTME BURADA: className={`...`} şeklinde backtick (ters tırnak) eklendi.
    ...
    const fetchOrder = async () => {
      try {
        ...
        if (orderData) {
          ...
          // Doğrulama yönlendirmesi (3000 TL+)
            ...
            <>
              <div className="p-5 rounded-xl bg-slate-800/80 border border-slate-700 space-y-4">
                <div className="flex items-center justify-between p-3 rounded-lg bg-slate-900/50 border border-slate-600">
                  ...
                  <button onClick={copyOrderId} className="p-2 rounded-lg bg-slate-700 hover:bg-slate-600 transition-colors">
                ...
                <div className="p-4 rounded-xl bg-amber-900/20 border border-amber-700/50 text-sm text-amber-400">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-300/80">Yüksek tutarlı siparişiniz için güvenlik doğrulaması yapılması gerekmektedir.</p>
                    </div>
                  </div>
                </div>
              )}
