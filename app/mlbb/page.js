              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-3 md:gap-4">
                {products.map((product) => (
                  <div
                    ...
                    className="product-card-glow group relative rounded-lg overflow-hidden cursor-pointer transition-all duration-300 hover:shadow-xl flex flex-col border border-white/10 hover:border-white/20 w-full aspect-[2/3.8] md:aspect-[2/3]"
            ...
            <div className="space-y-5">
              ...
              {(siteSettings?.contactPhone || siteSettings?.contactEmail) && (
                <div className="space-y-2 pt-2">
                  ...
                  {/* Company Address */}
                  <div className="flex items-start gap-2 text-white/50 text-sm pt-1">
                    <svg className="w-4 h-4 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <span>Kırkkonaklar, 329. Cadde<br />Daruk Apt. 27/A<br />06610 Çankaya/Ankara</span>
                  </div>
                </div>
              )}
