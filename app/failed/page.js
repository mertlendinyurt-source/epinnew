      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700 shadow-2xl">
          ...
          <div className="space-y-4">
            {/* Bank Maintenance Warning */}
            <div className="bg-yellow-900/30 rounded-lg p-4 border border-yellow-600/40">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-yellow-400 font-bold text-sm mb-1">⚠️ {isEN ? 'Bank Maintenance Notice' : 'Banka Bakım Bildirimi'}</h3>
                  <p className="text-yellow-200/80 text-sm leading-relaxed">
                    {isEN 
                      ? 'Garanti Bank and Ziraat Bank payment systems are currently under maintenance. Please try with a different bank card.'
                      : 'Garanti Bankası ve Ziraat Bankası ödeme sistemleri şu anda bakımdadır. Lütfen farklı bir banka kartı ile deneyiniz.'}
                  </p>
                </div>
              </div>
            </div>
