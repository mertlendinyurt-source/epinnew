// insert-legal-pages.js - MongoDB shell script for legal pages
// Run with: mongosh pinly_store /app/scripts/insert-legal-pages.js
...
// Clear existing legal pages and insert new ones
db.legal_pages.deleteMany({});
print('Existing legal pages cleared');

legalPages.forEach(page => {
  db.legal_pages.insertOne(page);
  print('Created: ' + page.title);
});

print('All 6 legal pages created successfully!');
print('');
print('Slug List:');
legalPages.forEach(page => {
  print('  - /legal/' + page.slug);
});
