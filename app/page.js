    ...
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-[#1e2229] rounded-xl overflow-hidden">
          {/* Tab Bar */}
          <div className="flex border-b border-white/10 items-center justify-between">
            <div className="flex">
              <button
            ...
            <a
              ...
              className="mr-4 flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-full text-sm font-medium transition-all duration-300 shadow-lg shadow-green-500/25 hover:shadow-green-500/40 hover:scale-105"
            >
