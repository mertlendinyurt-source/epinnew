              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-3 md:gap-4">
                {products.map((product) => (
                  ...
                  >
                    ...
                    {/* Info Icon */}
                    <div className={`absolute ${(product.vpAmount === 8900 || product.ucAmount === 8900 || product.title?.includes('8900') || product.discountPrice === 1350) ? 'top-8' : 'top-2'} right-2 w-6 h-6 md:w-5 md:h-5 rounded-full bg-white/90 flex items-center justify-center z-20`}>
